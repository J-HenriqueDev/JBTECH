...
<body>
    <div class="container">
        ...
        <div class="info-section">
            ...
            <p><strong>Estoque Baixo (≤ 10):</strong> {{ $produtosBaixo->count() }}</p>
            <p><strong>Estoque Médio (11-50):</strong> {{ $produtosMedio->count() }}</p>
            <p><strong>Estoque Alto (> 50):</strong> {{ $produtosAlto->count() }}</p>
        </div>
