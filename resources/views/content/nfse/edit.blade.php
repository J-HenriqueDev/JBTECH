...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="mb-0 text-primary">
            <i class="bx bx-edit-alt"></i> Editar Nota Fiscal de Serviço
        </h1>
                            ...
                            <select name="cliente_id" class="form-select select2" required>
                                ...
                                @foreach ($clientes as $cliente)
                                    <option value="{{ $cliente->id }}"
                                        {{ old('cliente_id', $nfse->cliente_id) == $cliente->id ? 'selected' : '' }}>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea id="discriminacao" name="discriminacao" class="form-control" rows="4" required
                                    placeholder="Descreva o serviço prestado...">{{ old('discriminacao', $nfse->discriminacao) }}</textarea>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" id="codigo_servico" name="codigo_servico" class="form-control"
                                    value="{{ old('codigo_servico', $nfse->codigo_servico) }}" placeholder="Ex: 14.01">
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="municipio_prestacao" class="form-control"
                                    value="{{ old('municipio_prestacao', $nfse->municipio_prestacao) }}"
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" name="valor_servico" class="form-control form-control-lg"
                                value="{{ old('valor_servico', $nfse->valor_servico) }}" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" id="aliquota_iss" name="aliquota_iss" class="form-control"
                                value="{{ old('aliquota_iss', $nfse->aliquota_iss) }}">
                        </div>

                        <div class="mb-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="iss_retido" name="iss_retido"
                                    {{ old('iss_retido', $nfse->iss_retido) ? 'checked' : '' }}>
                        ...
                        <div class="d-grid gap-2">
                            ...
                            <button type="submit" name="emitir_agora" value="true" class="btn btn-primary">
                                <i class="bx bx-send me-1"></i> Atualizar e Emitir
                            </button>
                        </div>
                    </div>
                </div>
