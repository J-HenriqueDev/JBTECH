...
<h1 class="mb-4 text-primary" style="font-size: 2.5rem; font-weight: bold; text-shadow: 1px 1px 2px rgba(0, 0, 0, 0.2);">
  <i class="bx bx-file"></i> Editar OS
</h1>
                ...
                <div class="card-body">
                    <div class="row">
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <textarea class="form-control" name="problema_item" id="descricao" rows="4" placeholder="Computador com muita lentidão, liga e às vezes fica em tela preta." required>{{ old('problema_item', $os->problema_item) }}</textarea>
                            @error('problema_item')
                            <small class="text-danger fw-bold">{{ $message }}</small>
                            @enderror
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" name="modelo_do_dispositivo" id="modelo_pc" placeholder="Ex: ACER NITRO 5" aria-label="Modelo do dispositivo" value="{{ old('modelo_do_dispositivo', $os->modelo_do_dispositivo) }}">
                            @error('modelo_do_dispositivo')
                            <small class="text-danger fw-bold">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" name="sn" id="sn" placeholder="Ex: 123456789" aria-label="S/N do dispositivo" value="{{ old('sn', $os->sn) }}">
                            @error('sn')
                            <small class="text-danger fw-bold">{{ $message }}</small>
                            @enderror
                        </div>
                                    ...
                                    <div class="swiper-wrapper" id="swiper-wrapper">
                                        @foreach($os->fotos as $foto)
                                            <div class="swiper-slide">
                                                <img src="{{ asset('storage/' . $foto) }}" alt="Imagem do equipamento">
                                            </div>
                                        @endforeach
                                    </div>
