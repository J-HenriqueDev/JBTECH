            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs mb-4" role="tablist">
                        <li class="nav-item">
                            <button type="button" class="nav-link active" data-bs-toggle="tab" data-bs-target="#geral"
                                role="tab">
                        ...
                        @if (auth()->user()->isAdmin())
                            <li class="nav-item">
                                <button type="button" class="nav-link" data-bs-toggle="tab" data-bs-target="#email"
                                    role="tab">
                        ...
                        @endif
                        <li class="nav-item">
                            <button type="button" class="nav-link" data-bs-toggle="tab" data-bs-target="#produtos"
                                role="tab">
                                <i class="bx bx-package"></i> Produtos
                            </button>
                        </li>
                        <li class="nav-item">
                            <button type="button" class="nav-link" data-bs-toggle="tab" data-bs-target="#vendas"
                                role="tab">
                                <i class="bx bx-cart"></i> Vendas
                            </button>
                        </li>
                        <li class="nav-item">
                            <button type="button" class="nav-link" data-bs-toggle="tab" data-bs-target="#financeiro"
                                role="tab">
                                <i class="bx bx-dollar-circle"></i> Financeiro
                            </button>
                        </li>
                        <li class="nav-item">
                            <button type="button" class="nav-link" data-bs-toggle="tab" data-bs-target="#clientes"
                                role="tab">
                                <i class="bx bx-user"></i> Clientes
                            </button>
                        </li>
                        <li class="nav-item">
                            <button type="button" class="nav-link" data-bs-toggle="tab" data-bs-target="#relatorios"
                                role="tab">
                                <i class="bx bx-bar-chart"></i> Relatórios
                            </button>
                        </li>
                        <li class="nav-item">
                            <button type="button" class="nav-link" data-bs-toggle="tab" data-bs-target="#interface"
                                role="tab">
                        ...
                        @if (auth()->user()->isAdmin())
                            <li class="nav-item">
                                <button type="button" class="nav-link" data-bs-toggle="tab" data-bs-target="#sistema"
                                    role="tab">
                            ...
                            <form action="{{ route('configuracoes.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="empresa_telefone" id="empresa_telefone"
                                    ...
                                    <div class="col-md-2 mb-3">
                                        ...
                                        <input type="text" name="empresa_cep" id="empresa_cep"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select name="email_driver" class="form-select">
                                                <option value="smtp"
                                                    {{ Configuracao::get('email_driver') == 'smtp' ? 'selected' : '' }}>
                                                    SMTP</option>
                                                <option value="mailgun"
                                                    {{ Configuracao::get('email_driver') == 'mailgun' ? 'selected' : '' }}>
                                                    Mailgun</option>
                                                <option value="ses"
                                                    {{ Configuracao::get('email_driver') == 'ses' ? 'selected' : '' }}>SES
                                                </option>
                                            </select>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <select name="email_criptografia" class="form-select">
                                                <option value="tls"
                                                    {{ Configuracao::get('email_criptografia') == 'tls' ? 'selected' : '' }}>
                                                    TLS</option>
                                                <option value="ssl"
                                                    {{ Configuracao::get('email_criptografia') == 'ssl' ? 'selected' : '' }}>
                                                    SSL</option>
                                            </select>
                                        </div>
                                        <div class="col-md-4 mb-3">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="produtos_edicao_inline" class="form-select">
                                            <option value="0"
                                                {{ Configuracao::get('produtos_edicao_inline', '0') == '0' ? 'selected' : '' }}>
                                                Desabilitado</option>
                                            <option value="1"
                                                {{ Configuracao::get('produtos_edicao_inline', '0') == '1' ? 'selected' : '' }}>
                                                Habilitado</option>
                                        </select>
                                        <small class="form-text text-muted">
                                            <i class="bx bx-info-circle"></i> Permite editar produtos diretamente na
                                            tabela. <strong>Individual por usuário.</strong>
                                        </small>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">
                                        ...
                                        <select name="produtos_controle_estoque" class="form-select">
                                            <option value="1"
                                                {{ Configuracao::get('produtos_controle_estoque', '1') == '1' ? 'selected' : '' }}>
                                                Habilitado</option>
                                            <option value="0"
                                                {{ Configuracao::get('produtos_controle_estoque', '1') == '0' ? 'selected' : '' }}>
                                                Desabilitado</option>
                                        </select>
                                        <small class="form-text text-muted">
                                            <i class="bx bx-info-circle"></i> Controla se o sistema deve gerenciar estoque
                                            automaticamente
                                        </small>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" name="produtos_estoque_minimo" class="form-control"
                                            value="{{ Configuracao::get('produtos_estoque_minimo', '10') }}"
                                            min="0">
                                        <small class="form-text text-muted">
                                            <i class="bx bx-info-circle"></i> Quantidade mínima padrão para alertas de
                                            estoque baixo
                                        </small>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="produtos_venda_estoque_negativo" class="form-select">
                                            <option value="0"
                                                {{ Configuracao::get('produtos_venda_estoque_negativo', '0') == '0' ? 'selected' : '' }}>
                                                Não Permitir</option>
                                            <option value="1"
                                                {{ Configuracao::get('produtos_venda_estoque_negativo', '0') == '1' ? 'selected' : '' }}>
                                                Permitir</option>
                                        </select>
                                        <small class="form-text text-muted">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="produtos_gerar_codigo_barras" class="form-select">
                                            <option value="1"
                                                {{ Configuracao::get('produtos_gerar_codigo_barras', '1') == '1' ? 'selected' : '' }}>
                                                Sim</option>
                                            <option value="0"
                                                {{ Configuracao::get('produtos_gerar_codigo_barras', '1') == '0' ? 'selected' : '' }}>
                                                Não</option>
                                        </select>
                                        <small class="form-text text-muted">
                                            <i class="bx bx-info-circle"></i> Gera código de barras automaticamente ao
                                            criar produto. Se "Não", o campo ficará vazio.
                                        </small>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">
                                        ...
                                        <select name="produtos_exigir_imagem" class="form-select">
                                            <option value="0"
                                                {{ Configuracao::get('produtos_exigir_imagem', '0') == '0' ? 'selected' : '' }}>
                                                Opcional</option>
                                            <option value="1"
                                                {{ Configuracao::get('produtos_exigir_imagem', '0') == '1' ? 'selected' : '' }}>
                                                Obrigatório</option>
                                        </select>
                                        <small class="form-text text-muted">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" name="vendas_desconto_maximo" class="form-control"
                                            value="{{ Configuracao::get('vendas_desconto_maximo', '10') }}"
                                            min="0" max="100" step="0.01">
                                        <small class="form-text text-muted">
                                            <i class="bx bx-info-circle"></i> Percentual máximo de desconto que pode ser
                                            aplicado em vendas
                                        </small>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" name="vendas_comissao_padrao" class="form-control"
                                            value="{{ Configuracao::get('vendas_comissao_padrao', '0') }}" min="0"
                                            max="100" step="0.01">
                                        <small class="form-text text-muted">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="vendas_imprimir_automatico" class="form-select">
                                            <option value="0"
                                                {{ Configuracao::get('vendas_imprimir_automatico', '0') == '0' ? 'selected' : '' }}>
                                                Não</option>
                                            <option value="1"
                                                {{ Configuracao::get('vendas_imprimir_automatico', '0') == '1' ? 'selected' : '' }}>
                                                Sim</option>
                                        </select>
                                        <small class="form-text text-muted">
                                            <i class="bx bx-info-circle"></i> Imprime cupom automaticamente após finalizar
                                            venda
                                        </small>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="vendas_enviar_email" class="form-select">
                                            <option value="0"
                                                {{ Configuracao::get('vendas_enviar_email', '0') == '0' ? 'selected' : '' }}>
                                                Não</option>
                                            <option value="1"
                                                {{ Configuracao::get('vendas_enviar_email', '0') == '1' ? 'selected' : '' }}>
                                                Sim</option>
                                        </select>
                                        <small class="form-text text-muted">
                                            <i class="bx bx-info-circle"></i> Envia email com detalhes da venda para o
                                            cliente
                                        </small>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="vendas_forma_pagamento_padrao" class="form-select">
                                            <option value="dinheiro"
                                                {{ Configuracao::get('vendas_forma_pagamento_padrao', 'dinheiro') == 'dinheiro' ? 'selected' : '' }}>
                                                Dinheiro</option>
                                            <option value="cartao_debito"
                                                {{ Configuracao::get('vendas_forma_pagamento_padrao', 'dinheiro') == 'cartao_debito' ? 'selected' : '' }}>
                                                Cartão Débito</option>
                                            <option value="cartao_credito"
                                                {{ Configuracao::get('vendas_forma_pagamento_padrao', 'dinheiro') == 'cartao_credito' ? 'selected' : '' }}>
                                                Cartão Crédito</option>
                                            <option value="pix"
                                                {{ Configuracao::get('vendas_forma_pagamento_padrao', 'dinheiro') == 'pix' ? 'selected' : '' }}>
                                                PIX</option>
                                        </select>
                                        <small class="form-text text-muted">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" name="vendas_garantia_padrao" class="form-control"
                                            value="{{ Configuracao::get('vendas_garantia_padrao', '90') }}"
                                            min="0">
                                        <small class="form-text text-muted">
                                            <i class="bx bx-info-circle"></i> Prazo padrão de garantia para produtos
                                            vendidos
                                        </small>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" name="vendas_custo_km" class="form-control"
                                            value="{{ Configuracao::get('vendas_custo_km', '1.50') }}" min="0"
                                            step="0.01">
                                        <small class="form-text text-muted">
                                            <i class="bx bx-info-circle"></i> Valor utilizado para cálculo de deslocamento
                                            em orçamentos (ida e volta)
                                        </small>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-12 mb-4">
                                        <h5 class="fw-bold"><i class="bx bx-credit-card me-2"></i>Taxas da Maquininha e
                                            Pagamentos</h5>
                                        <p class="text-muted">Defina as taxas cobradas pela operadora de cartão e outros
                                            meios de pagamento.</p>
                                    </div>

                                    <div class="col-md-4 mb-3">
                                        <label class="form-label">Taxa Débito (%)</label>
                                        <div class="input-group">
                                            <input type="text" name="financeiro_taxa_debito" class="form-control"
                                                value="{{ Configuracao::get('financeiro_taxa_debito', '0.00') }}"
                                                placeholder="0,00">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="financeiro_taxa_pix" class="form-control"
                                                value="{{ Configuracao::get('financeiro_taxa_pix', '0.00') }}"
                                                placeholder="0,00">
                                            <span class="input-group-text">%</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <label class="form-label">Taxa Crédito à Vista (1x) (%)</label>
                                        <div class="input-group">
                                            <input type="text" name="financeiro_taxa_cartao_1x" class="form-control"
                                                value="{{ Configuracao::get('financeiro_taxa_cartao_1x', '0.00') }}"
                                                placeholder="0,00">
                                            <span class="input-group-text">%</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <label class="form-label mb-2">Taxas Crédito Parcelado (2x a 12x)</label>
                                        <div class="row">
                                            @for ($i = 2; $i <= 12; $i++)
                                                <div class="col-md-3 mb-3">
                                                    <label class="form-label small">Parcela {{ $i }}x
                                                        (%)</label>
                                                    <div class="input-group input-group-sm">
                                                        <input type="text"
                                                            name="financeiro_taxa_cartao_{{ $i }}x"
                                                            class="form-control"
                                                            value="{{ Configuracao::get('financeiro_taxa_cartao_' . $i . 'x', '0.00') }}"
                                                            placeholder="0,00">
                                                        <span class="input-group-text">%</span>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col-12 mt-3 mb-2">
                                        <div class="divider text-start">
                                            <div class="divider-text fw-bold">Taxas de Boleto</div>
                                        </div>
                                    </div>

                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">Taxa Boleto (Valor Fixo)</label>
                                        <div class="input-group">
                                            <span class="input-group-text">R$</span>
                                            <input type="text" name="financeiro_taxa_boleto_fixa"
                                                class="form-control money"
                                                value="{{ Configuracao::get('financeiro_taxa_boleto_fixa', '0,00') }}"
                                                placeholder="0,00">
                                        </div>
                                    </div>

                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">Taxa Boleto (Porcentagem)</label>
                                        <div class="input-group">
                                            <input type="text" name="financeiro_taxa_boleto_porcentagem"
                                                class="form-control"
                                                value="{{ Configuracao::get('financeiro_taxa_boleto_porcentagem', '0.00') }}"
                                                placeholder="0,00">
                                            <span class="input-group-text">%</span>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="clientes_exigir_documento" class="form-select">
                                            <option value="0"
                                                {{ Configuracao::get('clientes_exigir_documento', '0') == '0' ? 'selected' : '' }}>
                                                Opcional</option>
                                            <option value="1"
                                                {{ Configuracao::get('clientes_exigir_documento', '0') == '1' ? 'selected' : '' }}>
                                                Obrigatório</option>
                                        </select>
                                        <small class="form-text text-muted">
                                            <i class="bx bx-info-circle"></i> Define se CPF/CNPJ é obrigatório no cadastro
                                            de clientes
                                        </small>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="clientes_exigir_email" class="form-select">
                                            <option value="0"
                                                {{ Configuracao::get('clientes_exigir_email', '0') == '0' ? 'selected' : '' }}>
                                                Opcional</option>
                                            <option value="1"
                                                {{ Configuracao::get('clientes_exigir_email', '0') == '1' ? 'selected' : '' }}>
                                                Obrigatório</option>
                                        </select>
                                        <small class="form-text text-muted">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="clientes_exigir_telefone" class="form-select">
                                            <option value="0"
                                                {{ Configuracao::get('clientes_exigir_telefone', '0') == '0' ? 'selected' : '' }}>
                                                Opcional</option>
                                            <option value="1"
                                                {{ Configuracao::get('clientes_exigir_telefone', '0') == '1' ? 'selected' : '' }}>
                                                Obrigatório</option>
                                        </select>
                                        <small class="form-text text-muted">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" name="clientes_limite_credito_padrao" class="form-control"
                                            value="{{ Configuracao::get('clientes_limite_credito_padrao', '0') }}"
                                            min="0" step="0.01">
                                        <small class="form-text text-muted">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" name="clientes_prazo_vencimento_padrao"
                                            class="form-control"
                                            value="{{ Configuracao::get('clientes_prazo_vencimento_padrao', '30') }}"
                                            min="1">
                                        <small class="form-text text-muted">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="clientes_alertar_inadimplente" class="form-select">
                                            <option value="1"
                                                {{ Configuracao::get('clientes_alertar_inadimplente', '1') == '1' ? 'selected' : '' }}>
                                                Sim</option>
                                            <option value="0"
                                                {{ Configuracao::get('clientes_alertar_inadimplente', '1') == '0' ? 'selected' : '' }}>
                                                Não</option>
                                        </select>
                                        <small class="form-text text-muted">
                                            <i class="bx bx-info-circle"></i> Exibe alerta ao tentar vender para cliente
                                            inadimplente
                                        </small>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="relatorios_formato_padrao" class="form-select">
                                            <option value="pdf"
                                                {{ Configuracao::get('relatorios_formato_padrao', 'pdf') == 'pdf' ? 'selected' : '' }}>
                                                PDF</option>
                                            <option value="excel"
                                                {{ Configuracao::get('relatorios_formato_padrao', 'pdf') == 'excel' ? 'selected' : '' }}>
                                                Excel</option>
                                            <option value="csv"
                                                {{ Configuracao::get('relatorios_formato_padrao', 'pdf') == 'csv' ? 'selected' : '' }}>
                                                CSV</option>
                                        </select>
                                        <small class="form-text text-muted">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="relatorios_imprimir_cabecalho" class="form-select">
                                            <option value="1"
                                                {{ Configuracao::get('relatorios_imprimir_cabecalho', '1') == '1' ? 'selected' : '' }}>
                                                Sim</option>
                                            <option value="0"
                                                {{ Configuracao::get('relatorios_imprimir_cabecalho', '1') == '0' ? 'selected' : '' }}>
                                                Não</option>
                                        </select>
                                        <small class="form-text text-muted">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" name="relatorios_periodo_padrao" class="form-control"
                                            value="{{ Configuracao::get('relatorios_periodo_padrao', '30') }}"
                                            min="1">
                                        <small class="form-text text-muted">
                                            <i class="bx bx-info-circle"></i> Período padrão em dias para filtros de
                                            relatórios
                                        </small>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="relatorios_agrupar_vendedor" class="form-select">
                                            <option value="0"
                                                {{ Configuracao::get('relatorios_agrupar_vendedor', '0') == '0' ? 'selected' : '' }}>
                                                Não</option>
                                            <option value="1"
                                                {{ Configuracao::get('relatorios_agrupar_vendedor', '0') == '1' ? 'selected' : '' }}>
                                                Sim</option>
                                        </select>
                                        <small class="form-text text-muted">
                                            <i class="bx bx-info-circle"></i> Agrupa resultados por vendedor nos relatórios
                                            de vendas
                                        </small>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="interface_tema" class="form-select">
                                            <option value="light"
                                                {{ Configuracao::get('interface_tema', 'light') == 'light' ? 'selected' : '' }}>
                                                Claro</option>
                                            <option value="dark"
                                                {{ Configuracao::get('interface_tema', 'light') == 'dark' ? 'selected' : '' }}>
                                                Escuro</option>
                                            <option value="auto"
                                                {{ Configuracao::get('interface_tema', 'light') == 'auto' ? 'selected' : '' }}>
                                                Automático</option>
                                        </select>
                                        <small class="form-text text-muted">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="interface_layout_menu" class="form-select">
                                            <option value="vertical"
                                                {{ Configuracao::get('interface_layout_menu', 'vertical') == 'vertical' ? 'selected' : '' }}>
                                                Vertical</option>
                                            <option value="horizontal"
                                                {{ Configuracao::get('interface_layout_menu', 'vertical') == 'horizontal' ? 'selected' : '' }}>
                                                Horizontal</option>
                                        </select>
                                        <small class="form-text text-muted">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="interface_densidade" class="form-select">
                                            <option value="compact"
                                                {{ Configuracao::get('interface_densidade', 'compact') == 'compact' ? 'selected' : '' }}>
                                                Compacto</option>
                                            <option value="comfortable"
                                                {{ Configuracao::get('interface_densidade', 'compact') == 'comfortable' ? 'selected' : '' }}>
                                                Confortável</option>
                                            <option value="spacious"
                                                {{ Configuracao::get('interface_densidade', 'compact') == 'spacious' ? 'selected' : '' }}>
                                                Espaçoso</option>
                                        </select>
                                        <small class="form-text text-muted">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="interface_mostrar_icones" class="form-select">
                                            <option value="1"
                                                {{ Configuracao::get('interface_mostrar_icones', '1') == '1' ? 'selected' : '' }}>
                                                Sim</option>
                                            <option value="0"
                                                {{ Configuracao::get('interface_mostrar_icones', '1') == '0' ? 'selected' : '' }}>
                                                Não</option>
                                        </select>
                                        <small class="form-text text-muted">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="interface_mostrar_notificacoes" class="form-select">
                                            <option value="1"
                                                {{ Configuracao::get('interface_mostrar_notificacoes', '1') == '1' ? 'selected' : '' }}>
                                                Sim</option>
                                            <option value="0"
                                                {{ Configuracao::get('interface_mostrar_notificacoes', '1') == '0' ? 'selected' : '' }}>
                                                Não</option>
                                        </select>
                                        <small class="form-text text-muted">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="file" name="interface_logo" class="form-control"
                                            accept="image/*">
                                        @if (Configuracao::get('interface_logo'))
                                            <small class="form-text text-muted d-block mt-2">
                                                <i class="bx bx-info-circle"></i> Logo atual:
                                                {{ Configuracao::get('interface_logo') }}
                                            </small>
                                        @endif
                                        <small class="form-text text-muted">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select name="sistema_timezone" class="form-select">
                                                <option value="America/Sao_Paulo"
                                                    {{ Configuracao::get('sistema_timezone') == 'America/Sao_Paulo' ? 'selected' : '' }}>
                                                    America/Sao_Paulo</option>
                                                <option value="America/Manaus"
                                                    {{ Configuracao::get('sistema_timezone') == 'America/Manaus' ? 'selected' : '' }}>
                                                    America/Manaus</option>
                                                <option value="America/Fortaleza"
                                                    {{ Configuracao::get('sistema_timezone') == 'America/Fortaleza' ? 'selected' : '' }}>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select name="sistema_locale" class="form-select">
                                                <option value="pt_BR"
                                                    {{ Configuracao::get('sistema_locale') == 'pt_BR' ? 'selected' : '' }}>
                                                    Português (Brasil)</option>
                                                <option value="en"
                                                    {{ Configuracao::get('sistema_locale') == 'en' ? 'selected' : '' }}>
                                                    English</option>
                                            </select>
                                        </div>
                                        <div class="col-md-6 mb-3">
        ...
        $(document).ready(function() {
            ...
            $('#btnTestarCertificado').on('click', function(e) {
                ...
                if (!certificado && !certExists) {
                    resultadoDiv.html(
                        '<div class="alert alert-warning mb-0"><i class="bx bx-error"></i> Selecione um arquivo de certificado primeiro ou verifique se já existe um carregado.</div>'
                    );
                    return;
                }
                ...
                if (certificado && (!senha || senha.trim() === '')) {
                    resultadoDiv.html(
                        '<div class="alert alert-warning mb-0"><i class="bx bx-error"></i> Para testar um novo arquivo, digite a senha.</div>'
                    );
                    return;
                }
                ...
                if (!certificado && !passwordSaved && (!senha || senha.trim() === '')) {
                    resultadoDiv.html(
                        '<div class="alert alert-warning mb-0"><i class="bx bx-error"></i> Digite a senha do certificado.</div>'
                    );
                    return;
                }
                ...
                resultadoDiv.html(
                    '<div class="alert alert-info mb-0"><i class="bx bx-loader bx-spin"></i> Testando certificado...</div>'
                );
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            resultadoDiv.html(
                                '<div class="alert alert-success mb-0"><i class="bx bx-check-circle"></i> ' +
                                response.message + '</div>');
                        } else {
                            resultadoDiv.html(
                                '<div class="alert alert-danger mb-0"><i class="bx bx-error"></i> ' +
                                response.message + '</div>');
                        }
                    },
                    error: function(xhr) {
                    ...
                    complete: function() {
                        btnTestar.prop('disabled', false).html(
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data.ddd_telefone_1) {
                            $('input[name="empresa_telefone"]').val(
