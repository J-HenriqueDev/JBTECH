            ...
            <div class="col-12">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="natureza_operacao" class="form-select select2" required>
                                    ...
                                    @foreach ($naturezas as $nat)
                                        <option value="{{ $nat->descricao }}"
                                            @if ($nat->padrao) selected @endif>{{ $nat->descricao }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-3">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="destinatario_tipo" id="tipo_cliente"
                                    value="cliente" checked onchange="toggleDestinatario()">
                                <label class="form-check-label" for="tipo_cliente">Cliente</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="destinatario_tipo" id="tipo_fornecedor"
                                    value="fornecedor" onchange="toggleDestinatario()">
                                <label class="form-check-label" for="tipo_fornecedor">Fornecedor</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="destinatario_tipo" id="tipo_proprio"
                                    value="proprio" onchange="toggleDestinatario()">
                        ...
                        <div id="div-fornecedor" class="mb-3" style="display: none;">
                            ...
                            <select name="destinatario_id_fornecedor" id="select_fornecedor" class="select2 form-select">
                                ...
                                @foreach ($fornecedores as $fornecedor)
                                    <option value="{{ $fornecedor->id }}" data-cnpj="{{ $fornecedor->cnpj }}">
                        ...
                        <div class="row g-3">
                            <div class="col-md-2">
                                ...
                                <div class="input-group">
                                    <input type="text" name="destinatario_endereco_cep" id="dest_cep"
                                        class="form-control">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="destinatario_endereco_logradouro" id="dest_logradouro"
                                    class="form-control">
                            </div>
                            <div class="col-md-2">
                                <label class="form-label">Número</label>
                                <input type="text" name="destinatario_endereco_numero" id="dest_numero"
                                    class="form-control">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label">Bairro</label>
                                <input type="text" name="destinatario_endereco_bairro" id="dest_bairro"
                                    class="form-control">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label">Cidade</label>
                                <input type="text" name="destinatario_endereco_cidade" id="dest_cidade"
                                    class="form-control">
                            </div>
                            <div class="col-md-2">
                                <label class="form-label">UF</label>
                                <input type="text" name="destinatario_endereco_uf" id="dest_uf"
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td colspan="2" class="fw-bold">
                                            ...
                                            <input type="hidden" id="total_nota_valor" name="total_nota_valor"
                                                value="0">
                                        </td>
                                    </tr>
                                </tfoot>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="number" min="1" value="1" class="form-control"
                                        id="qtd_duplicatas" placeholder="Qtd">
                                    ...
                                    <button type="button" class="btn btn-outline-primary"
                                        id="btnGerarDuplicatas">Gerar</button>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body" id="observacoes-container" style="display:none;">
                        <textarea name="infAdic[infCpl]" class="form-control" rows="3"
                            placeholder="Digite observações adicionais para a nota (opcional)"></textarea>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <select id="modal_produto_id" class="select2 form-select" style="width: 100%">
                            ...
                            @foreach ($produtos as $prod)
                                <option value="{{ $prod->id }}" data-price="{{ $prod->preco_venda }}"
                                    data-nome="{{ $prod->nome }}">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control text-center" id="modal_quantidade" value="1"
                                min="0.01" step="0.01">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            <span class="input-group-text">R$</span>
                            <input type="text" class="form-control bg-light" id="modal_valor_total"
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function buscarProdutoPorCodigo(barcode, qtd = 1, customPrice = null) {
                ...
                $.ajax({
                    ...
                    error: function(xhr) {
                        console.error(xhr);
                        alert('Erro ao buscar produto: ' + (xhr.responseJSON?.message ||
                            'Erro desconhecido'));
                        $('#barcode-input').val('').select();
                    },
                    complete: function() {
