                    ...
                    <form action="{{ route('nfe.config.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <button class="btn btn-outline-primary" type="button"
                                        onclick="buscarCNPJ('nfe_cnpj', 'nfe_razao_social', 'nfe_cep', 'nfe_endereco_logradouro', 'nfe_endereco_numero', 'nfe_endereco_bairro', 'nfe_endereco_municipio', 'nfe_endereco_uf', 'nfe_telefone', null, 'nfe_nome_fantasia')">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select name="nfe_crt" id="nfe_crt" class="form-select">
                                    <option value="1" {{ Configuracao::get('nfe_crt') == '1' ? 'selected' : '' }}>1 -
                                        Simples Nacional</option>
                                    <option value="2" {{ Configuracao::get('nfe_crt') == '2' ? 'selected' : '' }}>2 -
                                        Simples Nacional Excesso</option>
                                    <option value="3" {{ Configuracao::get('nfe_crt') == '3' ? 'selected' : '' }}>3 -
                        ...
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                ...
                                <select name="nfe_ambiente" class="form-select">
                                    <option value="1"
                                        {{ Configuracao::get('nfe_ambiente') == '1' ? 'selected' : '' }}>Produção</option>
                                    <option value="2"
                                        {{ Configuracao::get('nfe_ambiente') == '2' ? 'selected' : '' }}>Homologação
                                    </option>
                                </select>
                            </div>
                            <div class="col-md-3 mb-3">
                            ...
                            <div class="col-md-3 mb-3">
                                <label class="form-label">Próximo Número NFe</label>
                                <input type="number" name="nfe_ultimo_numero" class="form-control"
                                    value="{{ Configuracao::get('nfe_ultimo_numero', '') }}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="form-label">Próximo Número NFS-e</label>
                                <input type="number" name="nfse_ultimo_numero" class="form-control"
                                    value="{{ Configuracao::get('nfse_ultimo_numero', '') }}">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="nfe_endereco_logradouro" id="nfe_endereco_logradouro"
                                    class="form-control" value="{{ Configuracao::get('nfe_endereco_logradouro', '') }}"
                                    required>
                            </div>
                            <div class="col-md-2 mb-3">
                                <label class="form-label">Número *</label>
                                <input type="text" name="nfe_endereco_numero" id="nfe_endereco_numero"
                                    class="form-control" value="{{ Configuracao::get('nfe_endereco_numero', '') }}"
                                    required>
                            </div>
                            <div class="col-md-4 mb-3">
                                <label class="form-label">Complemento</label>
                                <input type="text" name="nfe_endereco_complemento" id="nfe_endereco_complemento"
                                    class="form-control" value="{{ Configuracao::get('nfe_endereco_complemento', '') }}">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                <label class="form-label">Bairro *</label>
                                <input type="text" name="nfe_endereco_bairro" id="nfe_endereco_bairro"
                                    class="form-control" value="{{ Configuracao::get('nfe_endereco_bairro', '') }}"
                                    required>
                            </div>
                            <div class="col-md-4 mb-3">
                                <label class="form-label">Município *</label>
                                <input type="text" name="nfe_endereco_municipio" id="nfe_endereco_municipio"
                                    class="form-control" value="{{ Configuracao::get('nfe_endereco_municipio', '') }}"
                                    required>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" name="nfe_cep" id="nfe_cep" class="form-control"
                                    oninput="formatCEP(this)" maxlength="9"
                                    value="{{ Configuracao::get('nfe_cep', '') }}" required>
                            </div>
                            <div class="col-md-4 mb-3">
                                <label class="form-label">Telefone</label>
                                <input type="text" name="nfe_telefone" id="nfe_telefone" class="form-control"
                        ...
                        @if (isset($certificadoInfo) && !isset($certificadoInfo['erro']) && !empty($certificadoInfo))
                            <div class="card bg-label-secondary mb-3">
                                <div class="card-body">
                                    <h6 class="card-title text-primary"><i class="bx bx-shield-quarter"></i> Status do
                                        Certificado Atual</h6>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <p class="mb-1"><strong>Razão Social:</strong>
                                                {{ $certificadoInfo['razao_social'] ?? 'N/A' }}</p>
                                            <p class="mb-1"><strong>CNPJ:</strong>
                                                {{ $certificadoInfo['cnpj'] ?? 'N/A' }}</p>
                                        </div>
                                        <div class="col-md-6">
                                            <p class="mb-1"><strong>Válido de:</strong>
                                                {{ isset($certificadoInfo['valido_de']) ? $certificadoInfo['valido_de']->format('d/m/Y H:i:s') : 'N/A' }}
                                            </p>
                                            <p class="mb-1">
                                                <strong>Válido até:</strong>
                                                <span
                                                    class="{{ $certificadoInfo['expirado'] ? 'text-danger fw-bold' : 'text-success fw-bold' }}">
                                            ...
                                            <p class="mb-0">
                                                ...
                                                @else
                                                    <span class="badge bg-success text-black">Válido
                                                        ({{ $certificadoInfo['dias_restantes'] }} dias restantes)</span>
                                                @endif
                                            </p>
                                        </div>
                                    </div>
                        ...
                        <div class="alert alert-info">
                            ...
                            <strong>Importante:</strong> O certificado e a senha serão validados automaticamente antes de
                            salvar.
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="file" name="nfe_certificado" id="nfe_certificado" class="form-control"
                                    accept=".pfx">
                                <small class="form-text text-muted">
                                    ...
                                    @if (Storage::exists($certPath))
                                        <div class="alert alert-success d-flex align-items-center mt-2 mb-0 p-2"
                                            role="alert">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    <input type="text" name="nfe_cert_password" id="nfe_cert_password"
                                        class="form-control" value="{{ $senhaConfigurada ? '********' : '' }}"
