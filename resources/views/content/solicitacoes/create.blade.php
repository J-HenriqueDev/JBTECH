                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select id="atendente_id" name="atendente_id" class="select2 form-select">
                                    <option value="{{ auth()->id() }}" selected>Eu ({{ auth()->user()->name }})</option>
                            ...
                            <div class="col-md-3">
                                ...
                                <select id="canal_atendimento" name="canal_atendimento" class="select2 form-select"
                                    required>
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control" id="pendencias" name="pendencias" rows="2"
                                    placeholder="Ex: Aguardando senha, aguardando peça..."></textarea>
                            </div>
