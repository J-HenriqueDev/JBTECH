...
<script>
  ...
  function calculateProfit() {
    let custo = parseFloat(document.getElementById('preco_custo').value.replace(/\./g, '').replace(',', '.')) || 0;
    let venda = parseFloat(document.getElementById('preco_venda').value.replace(/\./g, '').replace(',', '.')) || 0;

    if (custo > 0 && venda > 0) {
      let lucro = ((venda - custo) / custo) * 100;
      document.getElementById('lucro_percentual').innerText = lucro.toFixed(2) + '% Lucro';
    } else {
      document.getElementById('lucro_percentual').innerText = '0%';
    }
  }
  ...
  let codigoIndex = {
    {
      $produto - > codigosAdicionais - > count()
    }
  };
            ...
            <div class="tab-pane fade show active" id="geral" role="tabpanel" aria-labelledby="geral-tab">
              <div class="row mb-3">
                <div class="col-md-6">
                  ...
                  <input type="text" class="form-control form-control-lg" name="nome" id="nome" value="{{ old('nome', $produto->nome) }}" placeholder="Ex: Teclado Gamer USB" required>
                  ...
                  <div id="sugestao-categoria" class="form-text text-info" style="display: none;">
                    <i class="fas fa-magic"></i> Sugestão: <span id="nome-categoria-sugerida"></span>
                ...
                <div class="col-md-3">
                  ...
                  <div class="input-group">
                    <input type="text" class="form-control" name="codigo_barras" id="codigo_barras" value="{{ old('codigo_barras', $produto->codigo_barras) }}" placeholder="{{ $gerarCodigoBarras ? 'Gerado Autom.' : 'EAN-13' }}">
                    <button class="btn btn-outline-primary" type="button" onclick="consultarFiscal()" title="Buscar na API">
                ...
                <div class="col-md-3">
                  ...
                  <div class="form-check form-switch mt-2">
                    <input class="form-check-input" type="checkbox" id="ativo" name="ativo" value="1" {{ old('ativo', $produto->ativo) ? 'checked' : '' }}>
              ...
              <div class="row">
                <div class="col-md-4">
                  ...
                  <select class="form-select" name="tipo_item" id="tipo_item">
                    ...
                    <option value="{{ $key }}" {{ old('tipo_item', $produto->tipo_item) == $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                  </select>
                </div>
              </div>
            ...
            <div class="tab-pane fade" id="estoque" role="tabpanel" aria-labelledby="estoque-tab">
              <div class="row mb-3">
                <div class="col-md-3">
                  ...
                  <input type="number" class="form-control" name="estoque" id="estoque" value="{{ old('estoque', $produto->estoque) }}">
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                  ...
                  <input type="number" class="form-control" name="estoque_maximo" id="estoque_maximo" value="{{ old('estoque_maximo', $produto->estoque_maximo) }}">
                </div>
                <div class="col-md-3">
                  <label for="localizacao" class="form-label">Localização</label>
                  <input type="text" class="form-control" name="localizacao" id="localizacao" value="{{ old('localizacao', $produto->localizacao) }}" placeholder="Corredor A, Prateleira 2">
                </div>
              </div>
            </div>
            ...
            <div class="tab-pane fade" id="tributacao" role="tabpanel" aria-labelledby="tributacao-tab">
              ...
              <div class="row mb-3">
                <div class="col-md-3">
                  ...
                  <div class="input-group">
                    <input type="text" class="form-control" name="ncm" id="ncm" value="{{ old('ncm', $produto->ncm) }}">
                    <button class="btn btn-outline-secondary" type="button" onclick="buscarNcm()" title="Buscar NCM Online">
                      <i class="fas fa-search"></i>
                    </button>
                  </div>
                </div>
                <div class="col-md-3">
                  ...
                  <input type="text" class="form-control" name="unidade_comercial" id="unidade_comercial" value="{{ old('unidade_comercial', $produto->unidade_comercial ?? 'UN') }}" maxlength="6">
                </div>
                <div class="col-md-3">
                  <label class="form-label">CEST</label>
                  <input type="text" class="form-control" name="cest" id="cest" value="{{ old('cest', $produto->cest) }}">
                </div>
                <div class="col-md-3">
                  <label class="form-label">CFOP Interno</label>
                  <input type="text" class="form-control" name="cfop_interno" id="cfop_interno" value="{{ old('cfop_interno', $produto->cfop_interno) }}" placeholder="5102">
                </div>
                <div class="col-md-3">
                  <label class="form-label">CFOP Externo</label>
                  <input type="text" class="form-control" name="cfop_externo" id="cfop_externo" value="{{ old('cfop_externo', $produto->cfop_externo) }}" placeholder="6102">
                </div>
              </div>
              <div class="row mb-3">
                <div class="col-md-3">
                  ...
                  <select class="form-select" name="origem" id="origem">
                    ...
                    <option value="1" {{ old('origem', $produto->origem) == '1' ? 'selected' : '' }}>1 - Estrangeira (Imp. Direta)</option>
                    <option value="2" {{ old('origem', $produto->origem) == '2' ? 'selected' : '' }}>2 - Estrangeira (Adq. no Int.)</option>
                  </select>
                </div>
                <div class="col-md-3">
                  <label class="form-label">CSOSN (Simples)</label>
                  <input type="text" class="form-control" name="csosn_icms" id="csosn_icms" value="{{ old('csosn_icms', $produto->csosn_icms) }}" placeholder="102">
                </div>
                <div class="col-md-3">
                  <label class="form-label">CST ICMS</label>
                  <input type="text" class="form-control" name="cst_icms" id="cst_icms" value="{{ old('cst_icms', $produto->cst_icms) }}" placeholder="00">
                </div>
              </div>
              <div class="row mb-3">
                <div class="col-md-4">
                  <label class="form-label">Alíquota ICMS (%)</label>
                  <input type="number" step="0.01" class="form-control" name="aliquota_icms" id="aliquota_icms" value="{{ old('aliquota_icms', $produto->aliquota_icms) }}">
                </div>
                <div class="col-md-4">
                  <label class="form-label">Alíquota PIS (%)</label>
                  <input type="number" step="0.01" class="form-control" name="aliquota_pis" id="aliquota_pis" value="{{ old('aliquota_pis', $produto->aliquota_pis) }}">
                </div>
                <div class="col-md-4">
                  <label class="form-label">Alíquota COFINS (%)</label>
                  <input type="number" step="0.01" class="form-control" name="aliquota_cofins" id="aliquota_cofins" value="{{ old('aliquota_cofins', $produto->aliquota_cofins) }}">
                </div>
              </div>
            </div>
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <select class="select2 form-select" name="fornecedores[]" multiple>
                    ...
                    <option value="{{ $fornecedor->id }}" {{ in_array($fornecedor->id, $fornecedoresSelecionados) ? 'selected' : '' }}>{{ $fornecedor->nome }} ({{ $fornecedor->cnpj ?? 'S/ CNPJ' }})</option>
                    @endforeach
                  </select>
              ...
              <div class="table-responsive">
                <table class="table table-bordered" id="tabelaCodigos">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td><input type="text" class="form-control" name="codigos_adicionais[{{ $index }}][codigo]" value="{{ $codigo->codigo }}"></td>
                      <td><input type="text" class="form-control" name="codigos_adicionais[{{ $index }}][descricao]" value="{{ $codigo->descricao }}"></td>
                      <td><button type="button" class="btn btn-danger btn-sm" onclick="this.closest('tr').remove()"><i class="fas fa-trash"></i></button></td>
                    </tr>
                    @endforeach
                  </tbody>
            ...
            <div class="tab-pane fade" id="outros" role="tabpanel" aria-labelledby="outros-tab">
              <div class="row mb-3">
                ...
                <div class="col-md-2">
                  ...
                  <input type="number" step="0.001" class="form-control" name="peso_liquido" value="{{ old('peso_liquido', $produto->peso_liquido) }}">
                </div>
                <div class="col-md-2">
                  <label class="form-label">Peso Bruto (kg)</label>
                  <input type="number" step="0.001" class="form-control" name="peso_bruto" value="{{ old('peso_bruto', $produto->peso_bruto) }}">
                </div>
                <div class="col-md-2">
                  <label class="form-label">Largura (cm)</label>
                  <input type="number" step="0.01" class="form-control" name="largura" value="{{ old('largura', $produto->largura) }}">
                </div>
                <div class="col-md-2">
                  <label class="form-label">Altura (cm)</label>
                  <input type="number" step="0.01" class="form-control" name="altura" value="{{ old('altura', $produto->altura) }}">
                </div>
                <div class="col-md-2">
                  <label class="form-label">Comprimento (cm)</label>
                  <input type="number" step="0.01" class="form-control" name="comprimento" value="{{ old('comprimento', $produto->comprimento) }}">
                </div>
              </div>
              <hr>
              <div class="row mb-3">
                ...
                <div class="col-md-3">
                  ...
                  <input type="text" class="form-control" name="preco_atacado" value="{{ number_format($produto->preco_atacado, 2, ',', '.') }}" oninput="formatCurrency(this)">
                </div>
                <div class="col-md-3">
                  <label class="form-label">Qtd. Mín. Atacado</label>
                  <input type="number" class="form-control" name="qtd_min_atacado" value="{{ old('qtd_min_atacado', $produto->qtd_min_atacado) }}">
                </div>
                <div class="col-md-3">
                  <label class="form-label">Preço Promocional</label>
                  <input type="text" class="form-control" name="preco_promocional" value="{{ number_format($produto->preco_promocional, 2, ',', '.') }}" oninput="formatCurrency(this)">
                </div>
              </div>
              <div class="row">
                <div class="col-md-12">
