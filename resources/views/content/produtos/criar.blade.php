...
@php
    $gerarCodigoBarras = \App\Models\Configuracao::get('produtos_gerar_codigo_barras', '1') == '1';
...
@section('page-script')
    ...
    <script>
        ...
        function calculateProfit(index) {
            let custo = parseFloat(document.getElementById('preco_custo_' + index).value.replace(/\./g, '').replace(',',
                '.')) || 0;
            let venda = parseFloat(document.getElementById('preco_venda_' + index).value.replace(/\./g, '').replace(',',
                '.')) || 0;
            ...
            if (custo > 0 && venda > 0) {
                ...
                let el = document.getElementById('lucro_percentual_' + index);
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control form-control-lg"
                                            name="produtos[0][nome]" id="nome_0" placeholder="Ex: Teclado Gamer USB"
                                            required>
                                        <div class="invalid-feedback">O nome é obrigatório.</div>
                                        <div id="sugestao-categoria-0" class="form-text text-info"
                                            style="display: none;">
                                            <i class="fas fa-magic"></i> Sugestão: <span
                                                id="nome-categoria-sugerida-0"></span>
                                            <a href="#" onclick="aplicarSugestao(0, event)"
                                                class="fw-bold">Aplicar</a>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <label for="codigo_barras_0" class="form-label">Código de Barras
                                            (Principal)</label>
                                        <div class="input-group">
                                            <input type="text" class="form-control" name="produtos[0][codigo_barras]"
                                                id="codigo_barras_0"
                                                placeholder="{{ $gerarCodigoBarras ? 'Gerado Autom.' : 'EAN-13' }}">
                                            <button class="btn btn-outline-primary" type="button"
                                                onclick="consultarFiscal(0)" title="Buscar na API">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="form-check form-switch mt-2">
                                            <input class="form-check-input" type="checkbox" id="ativo_0"
                                                name="produtos[0][ativo]" value="1" checked>
