...
@php
$empresaEndereco = \App\Models\Configuracao::get('empresa_endereco') . ', ' .
...
<form action="{{ route('orcamentos.store') }}" method="POST">
  ...
  <div class="card mb-4">
    ...
    <div class="card-body">
      ...
      <div class="row mb-3">
        <div class="col-md-6">
          ...
          <select id="select2Basic" class="select2 form-select" name="cliente_id" required>
            ...
            @endphp
            <option value="{{ $cliente->id }}" data-endereco="{{ $endereco }}">#{{ $cliente->id }} - {{ $cliente->nome }} - {{ $cliente->cpf_cnpj }}</option>
            @endforeach
          </select>
          @error('cliente_id')
      ...
      <div class="row mb-3 align-items-end">
        <div class="col-md-9">
          ...
          <div class="input-group">
            ...
            <input type="text" class="form-control" name="endereco_cliente" id="endereco_cliente" placeholder="Endereço do cliente">
          </div>
        </div>
      ...
      <div id="alertCustoCombustivel" class="alert alert-warning alert-dismissible fade show d-none mt-3" role="alert">
      ...
      <div class="row align-items-end bg-light p-3 rounded mb-3 mx-1">
        <div class="col-md-8">
          ...
          <div class="input-group">
            ...
            <input type="text" class="form-control" name="valor_servico" id="valor_servico" placeholder="0,00" oninput="formatCurrencyService(this); validarValorServico()">
            <button type="button" class="btn btn-primary" id="adicionarServico">
              <i class="bx bx-plus me-1"></i> Incluir
            </button>
          </div>
          <small id="erro_valor_servico" class="text-danger fw-bold d-none mt-1">O valor do serviço deve ser maior ou igual ao custo de combustível.</small>
          @error('valor_servico')
          <small class="text-danger fw-bold">{{ $message }}</small>
          @enderror
        </div>
      ...
      <div class="row">
        <div class="col-md-12 mb-3">
          ...
          <textarea class="form-control" name="observacoes" id="observacoes" rows="4" placeholder="Observações, condições de pagamento..."></textarea>
        </div>

        <div class="col-md-12 mb-3">
          <div class="form-check form-switch">
            <input class="form-check-input" type="checkbox" name="enviar_email" id="enviar_email" checked>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="alert alert-info" role="alert">
          ...
          Se o produto não estiver na lista, <a href="{{ route('produtos.create') }}" target="_blank" class="fw-bold text-decoration-underline">cadastre-o aqui</a> e atualize a lista.
        </div>
        ...
        <div class="row mb-3">
          <div class="col-md-4">
            ...
            <div class="input-group">
              <span class="input-group-text">R$</span>
              <input type="text" class="form-control" id="valor_unitario" placeholder="0,00" oninput="formatCurrencyService(this)">
            </div>
          </div>
          <div class="col-md-4">
            ...
            <div class="input-group">
              ...
              <input type="number" class="form-control text-center" id="quantidade" value="1" min="1" required>
          ...
          <div class="col-md-4">
            ...
            <div class="input-group">
              <span class="input-group-text">R$</span>
              <input type="text" class="form-control bg-light" id="valor_total" placeholder="0,00" readonly>
            </div>
          </div>
        </div>
      </div>
