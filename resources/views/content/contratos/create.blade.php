...
@section('content')
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">Contratos /</span> Novo
    </h4>

    <div class="row">
        <div class="col-md-12">
            <div class="card mb-4">
                <h5 class="card-header">Detalhes do Contrato</h5>
                <div class="card-body">
                    <form action="{{ route('contratos.store') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="tipo" id="tipo_recorrente"
                                        value="recorrente"
                                        {{ old('tipo', 'recorrente') == 'recorrente' ? 'checked' : '' }}>
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="tipo" id="tipo_parcelado"
                                        value="parcelado" {{ old('tipo') == 'parcelado' ? 'checked' : '' }}>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" class="form-control" id="descricao" name="descricao"
                                    ...
                                    placeholder="Ex: Manutenção Mensal de Computadores">
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select select2" id="frequencia" name="frequencia" required>
                                    <option value="mensal" {{ old('frequencia') == 'mensal' ? 'selected' : '' }}>Mensal
                                    </option>
                                    <option value="trimestral" {{ old('frequencia') == 'trimestral' ? 'selected' : '' }}>
                                        Trimestral</option>
                                    <option value="semestral" {{ old('frequencia') == 'semestral' ? 'selected' : '' }}>
                                        Semestral</option>
                                    <option value="anual" {{ old('frequencia') == 'anual' ? 'selected' : '' }}>Anual
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select select2" id="forma_pagamento" name="forma_pagamento" required>
                                    <option value="boleto_pix"
                                        {{ old('forma_pagamento') == 'boleto_pix' ? 'selected' : '' }}>Boleto + PIX
                                        (Padrão)</option>
                                    <option value="boleto" {{ old('forma_pagamento') == 'boleto' ? 'selected' : '' }}>
                                        Apenas Boleto</option>
                                    <option value="pix" {{ old('forma_pagamento') == 'pix' ? 'selected' : '' }}>Apenas
                                        PIX</option>
                                    <option value="transferencia"
                                        {{ old('forma_pagamento') == 'transferencia' ? 'selected' : '' }}>Transferência
                                        Bancária</option>
                                    <option value="cartao" {{ old('forma_pagamento') == 'cartao' ? 'selected' : '' }}>
                                        Cartão de Crédito</option>
                                    <option value="outro" {{ old('forma_pagamento') == 'outro' ? 'selected' : '' }}>Outro
                                    </option>
                                </select>
                            </div>

                            <div class="col-md-4 mb-3">
                                <label for="dia_vencimento" class="form-label">Dia de Vencimento (Padrão)</label>
                                <input type="number" class="form-control" id="dia_vencimento" name="dia_vencimento"
                                    min="1" max="31" value="{{ old('dia_vencimento', 10) }}" required>
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="dias_personalizados"
                                    name="dias_personalizados" value="{{ old('dias_personalizados') }}"
                            ...
                            <div class="col-md-12 mb-3">
                                <label for="discriminacao_servico" class="form-label">Descrição do Serviço (NFS-e)
                                    *</label>
                                <textarea class="form-control" id="discriminacao_servico" name="discriminacao_servico" rows="3"
                                    placeholder="Descrição detalhada para a Nota Fiscal">{{ old('discriminacao_servico') }}</textarea>
                            </div>
                        ...
                        <div class="mt-2">
                            <button type="submit" class="btn btn-primary me-2">Salvar Contrato</button>
